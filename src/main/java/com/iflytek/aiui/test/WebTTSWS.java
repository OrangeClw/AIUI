...
public class WebTTSWS {
    ...
    private static final String appid = "5e0f0891";//到控制台-语音合成页面获取
    private static final String apiSecret = "6b981e633f2e20776070ccb92bde2473";//到控制台-语音合成页面获取
    private static final String apiKey = "cb7fbc6acc0d611f8fe7828e855b4502";//到控制台-语音合成页面获取
    private static final String path = "D:\\JavaEE\\intellsoft\\upload\\tts\\";
    private static final String text = "小了白了兔，白了兔了白";
    ...
    public static void main(String[] args) throws Exception {
        ...
        WebSocket webSocket = client.newWebSocket(request, new WebSocketListener() {
            ...
            public void onOpen(WebSocket webSocket, Response response) {
                ...
                business.addProperty("speed", 50);//音速
                business.addProperty("volume", 50);//音量
                business.addProperty("bgs", 1);//背景音
                business.addProperty("reg", "0");//英文单词发音方式
                //填充data
