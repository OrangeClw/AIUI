...
public class Face {
    ...
    private static final String APPID = "5e0f0891";
    // 接口密钥(webapi类型应用开通人脸比对服务后，控制台--我的应用---人脸比对---相应服务的apikey)
    private static final String API_KEY = "7bf28a9ef1834cbf77d7e04e2c79938e";
    // 图片地址
    private static final String FILE_PATH1 = "D:\\JavaEE\\intellsoft\\aiui\\src\\main\\resources\\static\\images\\liqin.jpg";
    private static final String FILE_PATH2 = "D:\\JavaEE\\intellsoft\\aiui\\src\\main\\resources\\static\\images\\liqin1.jpg";


//    public DataResult<String> voice2text(HttpSession session) throws Exception{
...
//    }
    ...
    public static Double login(String imgPath, String uPath) throws IOException, JSONException {
        Map<String, String> header = buildHttpHeader();
        //图片1和图片二Base64编码之后需要urlencode
        byte[] imageByteArray1 = FileUtil.read(uPath);
        String imageBase641 = new String(Base64.encodeBase64(imageByteArray1), "UTF-8");
        byte[] imageByteArray2 = FileUtil.read(imgPath);
        String imageBase642 = new String(Base64.encodeBase64(imageByteArray2), "UTF-8");
        String result = HttpUtil.doPost1(WEBWFV_URL, header, "first_image=" + URLEncoder.encode(imageBase641, "UTF-8") + "&" + "second_image=" + URLEncoder.encode(imageBase642, "UTF-8"));
        System.out.println("人脸比对接口调用结果：" + result);
        // 错误码链接：https://www.xfyun.cn/document/error-code （code返回错误 码时必看）
