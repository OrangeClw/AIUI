...
public class WebIATWS extends WebSocketListener {
    ...
    private static final String apiKey = "cb7fbc6acc0d611f8fe7828e855b4502"; //在控制台-我的应用-语音听写（流式版）获取
    private static final String apiSecret = "6b981e633f2e20776070ccb92bde2473"; //在控制台-我的应用-语音听写（流式版）获取
    private static final String appid = "5e0f0891"; //在控制台-我的应用获取
    private static String file = "D:\\JavaEE\\intellsoft\\aiui\\src\\main\\resources\\static\\voice\\16k_10.pcm"; // 中文
    private String url;
    ...
    public WebIATWS(String file) throws Exception {
        this();
        this.file = file;
    }
    public WebIATWS() throws Exception {
        //构建鉴权url
        String authUrl = getAuthUrl(hostUrl, apiKey, apiSecret);
        //将url中的 schema http:// 和 https:// 分别替换为ws:// 和 wss://
        this.url = authUrl.toString().replace("http://", "ws://").replace("https://", "wss://");
    }

    public DataResult<String> iat() throws Exception{
            ...
            if (resp.getData() != null) {
                if (resp.getData().getResult() != null) {
                    ...
                    try {
                        ...
                        dataResult.setCode(resp.getData().getStatus());
                        dataResult.setData(decoder.toString());
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
